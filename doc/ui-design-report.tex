...
\begin{document}
    ...
    The announcments page provides the instructor with a basic outline of the previous
    announcements and it enables the instructor to add a new announcement immidately on top.   
    They can easily type in the assignment and submit.
    ...
    The instructor panel is where the instructor uploads the assignment itself and the unit tests
    that they want to apply for those. After uploading the files, they can further configure the
    settings for that particular submission. For example, they can edit the deadline of the project
    by selecting the assignment deadline button and typing in the deadline on the panel that opens 
    on click. After the configurations are made for the submission, they can decide to submit this
    for their students clicking add assignment button.
