...
\begin{document}
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{ |>{\centering\arraybackslash}m{15.15cm}| }
            \hline
            \Large \textbf{Revised UI Design Report} \\
            \small (version 1.0) \\
            \small \textbf{\today} \\
            \hline
        \end{tabular}
    ...
    Solarized Dark (a popular color scheme among programmers) inspired syntax highlighting along with the results and details of the unit test. Next to that screen, there is a feedback display where the user can see the old
