...
\begin{document}
    ...
    \section{Details}
    % Please try to focus more on the features instead of how features will progress.
    ...
    % Good sub parts (outline) for parts of the app, However please avoid listing thoughts, instead try to write down the features
    ...
    There are some types of software that are similar to what LabConnect aims to achieve, however, they are not directly developed to supply instructors/TAs/students
    with quality of life enhancements in terms of CS courses and their lab sessions/assignments. 

    % Any alternatives? Any apps that do the same thing or similar thing? What are the upsides or downsides?
