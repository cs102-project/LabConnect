...
\begin{document}
    ...
    \begin{table}[ht]
        ...
        \resizebox{\textwidth}{!}{ \begin{NiceTabular}{ccccc}[hvlines,columns-width=auto]
            ...
            Meetable & AssignmentService & AttemptService & Course &  \\

            LineAfterClassChecker & AttemptService & SubmissionService & Instructor &  \\

            ClassNInterfaceNamingChecker & Announcement & Assignment & OperatorsSpaceChecker &  \\

            ForbiddenStatementChecker & Attempt & Attempt & ParenthesisSpaceChecker &  \\

            MethodNamingChecker & Course & Submission & ForbiddenStatementChecker &  \\

            OperatorsSpaceChecker & Feedback & LiveSession & ConstantNamingChecker &  \\

            ProgramHeaderJavadocChecker & ForbiddenStatementChecker & LiveSessionManager & ForLoopSemicolonChecker &  \\

            RegexHelper & MethodNamingChecker & TutoringSession & MethodNamingChecker &  \\

            Tester & RegexHelper & RegexHelper & IndentationChecker &  \\

            UserService & TestResult & StyleChecker & DecisionCurlyBracketsChecker &  \\

            Student & UserService & BadExampleException & MethodParenthesisSpaceChecker &  \\

            TeachingAssistant & Tutor & TestResult & LineAfterClassChecker &  \\
