...
\begin{document}
    ...
    \pagebreak
        ...
        \begin{figure}[H]
            \resizebox{0.14\textwidth}{!}{\minipage{0.20\textwidth}
        \includegraphics[width=\linewidth]{small-groups/app-config.jpg}
        \caption{Configurator Classes}\label{fig:awesome_image1}
        \endminipage}\hfill
        \resizebox{0.14\textwidth}{!}{\minipage{0.20\textwidth}
        \includegraphics[width=\linewidth]{small-groups/assignment.jpg}
        \caption{Course Classes}\label{fig:awesome_image2}
        \endminipage}\hfill
        \resizebox{0.14\textwidth}{!}{\minipage{0.20\textwidth}
        \includegraphics[width=\linewidth]{small-groups/controllers.jpg}
        \caption{Controller Layer Classes}\label{fig:awesome_image3}
        \endminipage}\hfill
        \resizebox{0.14\textwidth}{!}{\minipage{0.20\textwidth}%
        \includegraphics[width=\linewidth]{small-groups/live-session.jpg}
        \caption{Assignment Function Classes}\label{fig:awesome_image3}
        \endminipage}
        \end{figure}

        
\begin{figure}[H]
    \resizebox{0.12\textwidth}{!}{\minipage{0.20\textwidth}
  \includegraphics[width=\linewidth]{small-groups/app-config.jpg}
...
\begin{figure}[H]
    \resizebox{0.12\textwidth}{!}{\minipage{0.23\textwidth}
  \includegraphics[width=\linewidth]{small-groups/repositories.jpg}
  \caption{A really Awesome Image}\label{fig:awesome_image1}
\endminipage}\hfill
\resizebox{0.1175\textwidth}{!}{\minipage{0.23\textwidth}
...
\end{figure}
        ...
        \begin{figure}[H]
            \resizebox{0.14\textwidth}{!}{\minipage{0.24\textwidth}
        \includegraphics[width=\linewidth]{small-groups/repositories.jpg}
        \caption{Repository Classes}\label{fig:awesome_image1}
        \endminipage}\hfill
        \resizebox{0.14\textwidth}{!}{\minipage{0.24\textwidth}
        \includegraphics[width=\linewidth]{small-groups/service-layer.jpg}
        \caption{Service Layer Classes}\label{fig:awesome_image2}
        \endminipage}\hfill
        \resizebox{0.15\textwidth}{!}{\minipage{0.24\textwidth}%
        \includegraphics[width=\linewidth]{small-groups/users.jpg}
        \caption{User Classes}\label{fig:awesome_image3}
        \endminipage}
        \end{figure}
        \begin{figure}[H]
            \centering
            \resizebox{0.25\textwidth}{!}{\minipage{0.25\textwidth}
                \includegraphics[width=\textwidth]{small-groups/testing.jpg}
